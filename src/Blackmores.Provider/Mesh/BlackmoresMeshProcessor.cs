...
{
    public class Blackmores_Command_MeshProcessor : BaseMeshProcessor
    {
        public Blackmores_Command_MeshProcessor(ApplicationContext appContext)
            : base(appContext)
        {
        }

        public override Guid GetProviderId() =>
          BlackmoresConstants.ProviderId;
