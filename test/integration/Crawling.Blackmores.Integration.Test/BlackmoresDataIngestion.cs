...
{
    public class DataIngestion : IClassFixture<BlackmoresTestFixture>
    {
        private readonly BlackmoresTestFixture fixture;
        private readonly ITestOutputHelper output;

        public DataIngestion(BlackmoresTestFixture fixture, ITestOutputHelper output)
        {
